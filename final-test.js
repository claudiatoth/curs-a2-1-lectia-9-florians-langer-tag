// ============================================
// TEST FINAL - Florians langer Tag (A2.1 · Lecția 9)
// Claudia Toth · 15 întrebări (reflexiv Akkusativ + mich/mir + Perfekt + traducere)
// ============================================

const finalTestData = [
    // 🪞 Reflexiv Akkusativ (4)
    { type: 'multiple', category: '🪞 Reflexiv Akkusativ', question: 'Pronumele reflexiv la Akkusativ pentru „ich" este:', options: ['mich', 'mir', 'sich', 'dich'], correct: 'mich', explanation: 'ich → mich (Akkusativ). mir = Dativ.' },
    { type: 'luckentext', category: '🪞 Reflexiv Akkusativ', question: 'Completează (Akkusativ):', sentence: 'Er muss <strong>______</strong> beeilen.', translation: 'er → reflexiv', accept: ['sich'], correct: 'sich', explanation: 'er/sie/es → sich.' },
    { type: 'multiple', category: '🪞 Reflexiv Akkusativ', question: 'La persoana a 3-a (er/sie/es și sie/Sie), pronumele reflexiv este mereu:', options: ['sich', 'mich', 'ihn', 'es'], correct: 'sich', explanation: 'Atât er/sie/es, cât și sie/Sie folosesc sich.' },
    { type: 'luckentext', category: '🪞 Reflexiv Akkusativ', question: 'Completează (Akkusativ):', sentence: 'Wir freuen <strong>______</strong> auf den Urlaub.', translation: 'wir → reflexiv', accept: ['uns'], correct: 'uns', explanation: 'wir → uns.' },

    // 🆕 mich vs mir (4)
    { type: 'multiple', category: '🆕 mich vs mir', question: 'Când reflexivul e la Dativ (mir/dir)?', options: ['Când mai există un obiect direct (die Hände, die Zähne)', 'Întotdeauna', 'Niciodată', 'Doar la plural'], correct: 'Când mai există un obiect direct (die Hände, die Zähne)', explanation: 'Obiectul direct ocupă Akkusativul, deci reflexivul devine Dativ.' },
    { type: 'luckentext', category: '🆕 mich vs mir', question: 'Completează (apare un obiect: die Hände!):', sentence: 'Ich wasche <strong>______</strong> die Hände.', translation: 'obiect direct → Dativ', accept: ['mir'], correct: 'mir', explanation: 'Există obiect (die Hände) → reflexivul e Dativ: mir.' },
    { type: 'luckentext', category: '🆕 mich vs mir', question: 'Completează (fără obiect):', sentence: 'Ich wasche <strong>______</strong> .', translation: 'fără obiect → Akkusativ', accept: ['mich'], correct: 'mich', explanation: 'Fără obiect direct → Akkusativ: mich.' },
    { type: 'multiple', category: '🆕 mich vs mir', question: 'Care persoane se SCHIMBĂ între Akkusativ și Dativ?', options: ['doar ich și du', 'toate', 'doar wir și ihr', 'niciuna'], correct: 'doar ich și du', explanation: 'mich→mir, dich→dir. Restul (sich/uns/euch/sich) rămân la fel.' },

    // ⏮️ Perfekt (3)
    { type: 'multiple', category: '⏮️ Perfekt', question: 'Toate verbele reflexive fac Perfekt cu:', options: ['haben', 'sein', 'werden', 'haben sau sein'], correct: 'haben', explanation: 'Verbele reflexive fac Perfekt MEREU cu haben + sich.' },
    { type: 'luckentext', category: '⏮️ Perfekt', question: 'Completează Partizip II (sich beeilen):', sentence: 'Ich habe mich <strong>______</strong> .', translation: 'be- → fără ge-', accept: ['beeilt'], correct: 'beeilt', explanation: 'beeilen → beeilt (prefix be- → fără ge-).' },
    { type: 'luckentext', category: '⏮️ Perfekt', question: 'Completează Partizip II (sich anziehen):', sentence: 'Ich habe mich <strong>______</strong> .', translation: 'trennbar + tare', accept: ['angezogen'], correct: 'angezogen', explanation: 'anziehen → angezogen (an + ge + zogen).' },

    // 🗣️ Traducere (4)
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Mă spăl pe mâini.', accept: ['ich wasche mir die hände'], correct: 'Ich wasche mir die Hände.', explanation: 'Obiect (die Hände) → reflexiv Dativ: mir.' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Mă grăbesc.', accept: ['ich beeile mich'], correct: 'Ich beeile mich.', explanation: 'sich beeilen → ich beeile mich (Akkusativ).' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'S-a relaxat. (er, Perfekt)', accept: ['er hat sich entspannt'], correct: 'Er hat sich entspannt.', explanation: 'Perfekt: hat sich entspannt (haben + sich + Partizip II).' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți (imperativ, du):', ro: 'Grăbește-te!', accept: ['beeil dich', 'beeile dich'], correct: 'Beeil dich!', explanation: 'Imperativ du: Beeil dich! (pronumele reflexiv rămâne — dich).' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre verbele reflexive (mich/mir + Perfekt).</p>
            <ul class="test-info-list">
                <li>🪞 Reflexiv Akkusativ (4) · 🆕 mich vs mir (4) · ⏮️ Perfekt (3) · 🗣️ Traducere (4)</li>
